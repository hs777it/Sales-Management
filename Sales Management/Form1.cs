...
namespace Sales_Management
{
    public partial class frmMain : DevExpress.XtraBars.Ribbon.RibbonForm
    {
        ...
        private void frmMain_Load(object sender, EventArgs e)
        {
            ...
            if (Properties.Settings.Default.Product_Key == "Yes")
            {
                btnProductActive.Enabled=false;
                btnProductActive.Caption = "نسخة مرخصة";
            }
        }

        private void btnProductActive_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
        ...
        private void btnServerSettings_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
